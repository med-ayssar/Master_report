...
\begin{flushleft}
  {\fontfamily{phv}  
    ...
    \emptyLine%{\LARGE \textbf{First line of title}\\} 
    \emptyLine%{\LARGE \textbf{Second line of title}\\} 
    \emptyLine%{\LARGE \textbf{Third line of title}\\} % Replace with \emptyLine if title is shorter
    \emptyLine%{\LARGE \textbf{Forth line of title}\\} % Replace with \emptyLine if title is shorter
    \vspace{3em}
